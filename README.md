...
- **OpenWebUI friendly** – the chat endpoint mirrors OpenAI’s `/chat/completions` contract (including streaming), making PsyConnect a drop-in replacement for local UIs.
